...
::: tip Generated on 2022-03-18, from go-ipfs v0.13.0-dev
...
`curl -X POST -F file=@myfile "http://127.0.0.1:5001/api/v0/block/put?format=<value>&mhtype=sha2-256&mhlen=-1&pin=false&allow-big-block=false"`
